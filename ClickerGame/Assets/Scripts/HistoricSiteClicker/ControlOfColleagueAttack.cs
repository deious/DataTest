...
public class ControlOfColleagueAttack : MonoBehaviour {
    ...
    int ColleagueAttack()
    {
        ...
        return (RelicsManager.Instance.inColleagueDamage[colleagueNum] + RelicsManager.Instance.inColleagueDamage[colleagueNum] * RelicsManager.Instance.inRelicType[0]);
    }
}
