...
public class CreateSeed : MonoBehaviour
{
    ...
    public int lrPadding = 54, tbPadding = 48;
    public float seedSize = 200f;
    Vector2 cellSize, spacing;

    public int fontSize = 40;

    public Vector2 siAnchorMin = new Vector2(0f, 0.25f), siAnchorMax = new Vector2(1f, 0.95f);
    public Vector2 spAnchorMin = new Vector2(0f, 0.05f), spAnchorMax = new Vector2(1f, 0.25f);
    ...
    void Awake()
    {
        ...
        cellSize = new Vector2(seedSize, seedSize);
    ...
    void Start()
    {
        ...
        for (int i = 0; i < FarmManager.Instance.crops.Length; i++)
        {
            for (int j = 0; j < FarmManager.Instance.crops[i].cropSprites.Length; j++)
            {
                ...
                backgroundImage.sprite = seedSprite;
                backgroundImage.material = seedMaterial;
