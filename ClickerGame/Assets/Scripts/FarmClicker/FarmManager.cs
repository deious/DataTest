...
public class FarmManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        FirebaseManager.Instance.StartFarm(cropCount);

        // foodCount, goldAmount를 전체 GM에서 받아옴
        infos = GameManager.Instance.ToFarmManager();
        // 임시적으로 이식
    ...
    public void FarmToMain()
    {
        GameManager.Instance.FromFarmManager(foodCount, goldAmount);
    }
